...
export class UserApi extends runtime.BaseAPI {
    ...
    /**
     */
    async createUserRaw(requestParameters: CreateUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserCreateDTO>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => UserCreateDTOFromJSON(jsonValue));
    }

    /**
     */
    async createUser(requestParameters: CreateUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserCreateDTO> {
